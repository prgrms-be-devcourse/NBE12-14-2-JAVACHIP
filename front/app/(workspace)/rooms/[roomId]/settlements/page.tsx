                    ...
                    <div className="mt-4">
                        ...
                        {approvedRequests.length > 0 ? (
                            <select
                                ...
                                className="mt-2 h-12 w-full rounded-xl border border-zinc-200 bg-white px-4 text-sm text-zinc-900 outline-none transition focus:ring-2 focus:ring-indigo-100"
                            >
                        ...
                        {changes.length > 0 ? (
                            changes.map((change) => {
                                ...
                                return (
                                    <tr
                                        key={change.id}
                                        className="border-zinc-100 text-zinc-800 last:border-b-0"
                                    >
